...
<?php endif; ?>
    <footer id="footer">
		...
		<img src="<? echo $HTTP; ?>images/payment.png" class="icon-payment" />
            </div>
        </div>
...
<script type="text/javascript">
	...
	sitehelp_s.src = top.location.protocol + '//c.sitehelp.im/code.cgi?c=5001' + (top.location.protocol=='http:' ? '' : '&ssl=1') + '&rnd=' + Math.random();
