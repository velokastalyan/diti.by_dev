                        ...
                        <div class="product row">
                            ...
                            <div class="seven columns">
                                ...
                                <div class="top_product" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                    ...
                                    <link itemprop="availability" href="http://schema.org/PreOrder"><span class="label order"><?php CTemplate::loc_string('order_2_3_day'); ?></span>
                                    <?php endif; ?>
                                    <hr class="separator">
                                       ...
                                       <span class="old-currency">
                                        ...
                                        <?php endif; ?>*/?>
                                           ...
                                           <!-- <span itemprop="price"><?php echo number_format($product_arr[1]['discount'], 0, ',', ' '); ?></span> <span itemprop="priceCurrency">USD</span><br> -->
											...
											<?php else: ?>
                                                <?php echo get_price_in_rus_rub( $product_arr[1]['discount'], $product_arr[1]['dollar_currency'], $sd_dollar, $product_arr[1]['rouble_currency'], $sd_rur ); ?> RUR
											<?php endif; ?>
											</span>
									</span>
                                    ...
                                    <span class="price">
										...
										<?php endif; ?>
											...
											<?php else: ?>
                                                <?php echo get_price_in_rus_rub( $product_arr[1]['price'], $product_arr[1]['dollar_currency'], $sd_dollar, $product_arr[1]['rouble_currency'], $sd_rur ); ?> RUR
											<?php endif; ?>
