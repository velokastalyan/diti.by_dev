							 ...
							 <?php CForm::begin('order', 'post'); ?>
								 ...
								 <div class="actions_cart">
									 ...
									 <div class="buttons order_buttons">
										 ...
										 <a href="/" onclick="javascript: $('.shipping-form').slideDown(800, function() {  $('html, body').animate({ scrollTop: $('#review_form').offset().top }, 'slow'); }); 
										 
										
										 
										 
										 return false;" class="button">Оформить</a>
									 </div>
								 </div>
							 <?php CForm::end(); ?>
									 ...
									 <?php CForm::begin('shipping_info', 'post'); ?>
                                                                                ...
                                                                                <div class="row">
                                                                                        ...
                                                                                        <div class="ten columns payment<?php echo ((in_array('payment', $errors)) ? ' error_block' : null); ?>">
                                                                                            <label for="cash">
                                                                                                <input type="radio" id="cash" name="payment" value="cash"> наличными курьеру<Br>
                                                                                            </label>
                                                                                            <label for="card">
                                                                                                <input type="radio" id="card" name="payment" value="card"> пластиковой картой курьеру<Br>
                                                                                            </label>
                                                                                            <label for="halva">
                                                                                                <input type="radio" id="halva" name="payment" value="halva"> пластиковой картой рассрочки курьеру<Br>
                                                                                            </label>
                                                                                            <label for="visa">
