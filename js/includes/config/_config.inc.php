...
$RootPath = '/sportmax/'; // root path for http pages
...
define('DB_USER', 'sportmax'); // db user name
define('DB_PASSWORD', 'sportpass'); // db password
define('DB_DATABASE', 'xpgraph_sportmax'); // database name, will be created automatically
