...
$(function(){
    ...
    $(function(){
        ...
        *меню мобильный вид
        */
        $('#mob-menu-buttom').on('click', function(){
            if(widthx < 960) {                
                $('.main_menu').toggleClass('show');
                $('.main_menu > ul > li > a').css("pointer-events" , "none");
                }
                //else $('.main_menu').removeClass('show'); 
            })

        $('.main_menu ul li').on('click', function(){
            if(widthx < 960) {
                $('ul.sub',this).toggleClass('show');        
            }
        })

        /*
        *конец меню мобильный вид
        */
