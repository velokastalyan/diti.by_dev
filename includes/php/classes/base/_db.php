...
class CBaseDB
{
	 ...
	 * @access protected
	 */
	protected $can_connect = true;
	/**
	 * @var integer
	 * @access protected
	 */
	protected $_int_data_seek = 0;

	protected $now_stmt = '';
	protected $datetime_stmt = '';
	protected $clob_stmt = '';
	protected $auto_inc_stmt = '';
	protected $concat_func_stmt = '';
	 ...
	 * @access protected
	 */
	function _set_limit($sql, $limit){system_die('pure virtual call _set_limit()');}
	/**
